...
struct ImGuiContext
{
    ...
    float                   BeginComboLayoutPushHeight;         // Set via SetNextComboDropdownLayoutHeight; consumed next BeginCombo; 0 = use height heuristic
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        BeginComboLayoutPushHeight = 0.0f;
